...
<body>
	...
	<form action="ShoppingController" method="post">
		<center>
			<div id="pd">
				<h2>
					<font color=red>Update Products</font>
				</h2>
				<br> <br>
			</div>
		</center>
			...
			<div id="pd">
				<table cellspacing="5">
					<tr>
						...
						<br>
						<td><input type="text" value=<%=up_prod1.getPid()%> name="id"
							id="pid" size="35" /><br> <br></td>
					</tr>
					<tr>
						<td><font color=red>Product Name:</font></td>
						<br>
						<td><input type="text" value=<%=up_prod1.getPname()%>
							name="name" size="35" id="name" /><br> <br></td>
					</tr>
					<tr>
						<td><font color=red>Product Category:</font></td>
						<td>
							<%--<input type="text" value=<%=rs.getString(3) %> name="prodcategory" size="35" />--%>
					...
					<tr>
						...
						<td>
							<%-- <input type="text" value=<%=rs.getString(4) %> name="status" id="status" size="35">--%>
					...
					<tr>
						...
						<td><input type="number" value=<%=up_prod1.getPrice()%>
							name="price" size="35" id="price" /><br> <br></td>
					</tr>
					<tr>
						<td><font color=red>Product Description:</font></td>
						<td><textarea value=<%=up_prod1.getPdesc()%> name="pdesc"
								rows="5" size="35"></textarea><br> <br></td>
					</tr>
		...
		<center>
			...
			<input type="submit" class="button" value="updateproduct" id="submit"
				style="width: 295px;"> <input type="reset" value="Reset">
		</center>
