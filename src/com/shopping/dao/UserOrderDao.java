...
public class UserOrderDao {
	...
	public static void fetchUserOrder(String cid) {
		...
		try {
			con = DBUtil.getDBCon();
			ps = con.prepareStatement("select b.product_id,b.product_name,b.PRODUCT_CATEGORY,b.PRODUCT_STATUS,b.PRODUCT_PRICE,b.PRODUCT_DESC,a.ORDER_ID,a.ORDER_DATE,a.PAYMENT_MODE,a.order_status,a.quantity from order_details a join product1 b on a.product_id=b.product_id where a.CUSTOMER_ID=?");
			ps.clearParameters();
			ps.setString(1, cid);
			rs = ps.executeQuery();
